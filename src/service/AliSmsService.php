...
class AliSmsService extends Service
{
    ...
    public function initialize($cofig = array()) {
//        $cofig = array (
...
//        );
        // 配置参数
        $this->accessKeyId = sysconf('alisms.keyid') ?: '';
        $this->accessKeySecret = sysconf('alisms.keysecret') ?: '';
        $this->signName = sysconf('alisms.singname') ?: '';
